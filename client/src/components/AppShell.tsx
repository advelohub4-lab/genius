...
import { Bell, BookOpen, BriefcaseBusiness, ChevronRight, CircleDollarSign, ClipboardList, Home, LifeBuoy, LogOut, Menu, Settings, ShieldCheck, UserRound, X } from "lucide-react";
...
const menuItems = [...navItems,
  { href: "/app/activity", label: "Activity", icon: ClipboardList },
