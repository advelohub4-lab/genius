...
const menuItems = [
  ...
  ["/activate", "Activation"],
  ["/work/data-annotation", "Data Annotation"],
  ["/work/content-moderation", "Content Moderation"],
  ["/work/audio-transcription", "Audio Transcription"],
  ["/work/data-validation", "Data Validation"],
];
